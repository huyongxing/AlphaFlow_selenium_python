...
path = root_path + "\\AlphaFlow_selenium_python\\report\\html\\"
log_path = root_path + "\\AlphaFlow_selenium_python\\report\\logs\\"
...
class Logs():
    def __init__(self):
        try:
            File_Path = root_path + '\\AlphaFlow_selenium_python\\report\\logs\\' + directory_time + '\\'
            if not os.path.exists(File_Path):
                os.makedirs(File_Path)
        except BaseException as msg:
            print("新建目录失败：%s" % msg)
...
class Image():
    def catch_image(driver):
        ...
        #         root_path + '\\weihong_selenium_python\\report\\image\\' + directory_time + '\\' + picture_time + '.png')
        # except BaseException as pic_msg:
...
if __name__ == '__main__':
    # Report.sent_email("D:\\TestTool\\JetBrains\\PycharmProjects\\weihong_selenium_python\\report\html\\2020-02-08\Report2020-02-08-11_12_34.html")

    local = "D:\\TestTool\\JetBrains\\PycharmProjects\\AlphaFlow_selenium_python\\report\html\\2020-02-08\Report2020-02-08-11_12_34.html"
    report = Report.build_report(local)
    print(report)
